...
//                 <FiAlignJustify className='nav-icon-ph'/>    
//                 <img className="logo-ph"  src="/logo.svg" alt="Logo" />                        
...
//                    <Link to="/"><img className="logo-pc" src="/logo.svg" alt="Logo" /></Link> 
...
//                                     </ul>
//                                 </li>
//                                 <li><a href="#">買取</a><FaCaretDown/>
//                                     <ul className="dropdown">
//                                         <li><Link to='./kaitori'>eイヤホンの買取サービス</Link></li>
//                                         <li>無料査定のお申込み</li>
//                                         <li>買取金額を調べる</li>
//                                         <li>買取Q&A</li>
//                                     </ul>
//                                 </li>                         
//                                 <li><a href="#">修理</a><FaCaretDown/>
//                                 <ul className="dropdown">
//                                         <li>イヤホンクリニック</li>
//                                 </ul>
//                                 </li>
//                                 <li><a href="#">カスタムIEM</a><FaCaretDown/>
//                                 <ul className="dropdown">
//                                         <li>カスタムIEMとは</li>
//                                         <li>ブランド一覧</li>
//                                 </ul>
//                                 </li>
//                                 <li><a href="#">カテゴリ</a><FaCaretDown/>
//                                     <ul className="dropdown">
//                                         <li>ワイヤレス</li>
//                                         <li>有線イヤホン</li>
//                                         <li>有線ヘッドホン</li>
